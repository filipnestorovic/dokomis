         ...
         <span class="text-center m-4">
            <div class="text-center">
               <form wire:submit.prevent>
                   <div id="searchFormDiv" class="d-flex justify-content-center">
                       <div class="flex-column mr-3">
                          <div class="input-group mb-2 mr-sm-2">
                             ...
                             <input wire:model="companyName" type="text" class="form-control py-0" id="companyName">
                          </div>
                          @error('companyName')
                       ...
                       <div class="flex-column mr-3">
                          <div class="input-group mb-2 mr-sm-2">
                             ...
                             <input wire:model="companyVAT" type="text" class="form-control py-0" id="companyVAT">
                          </div>
                          @error('companyVAT')
                          <div class="text-danger">{{$message}}</div>
                          @enderror
                       ...
                       <div class="flex-column mr-3">
                          <div class="input-group mb-2 mr-sm-2">
                             ...
                             <input wire:model="certificateNumber" type="text" class="form-control py-0" id="certificateNumber">
                          </div>
                   ...
                   @if(!$errors->any()&&($companyName||$companyVAT||$certificateNumber))
                       <div class="d-flex justify-content-center">
                        <button wire:click="showResultTable" wire:keydown.enter="showResultTable" type="button"
                                class="btn btn-primary btn-rounded btn-md">Pretraži</button>
                       </div>
                       <!--<span wire:init="showResultTable"></span>-->
                   @else
                       <span>Da biste pretražili sertifikate, morate uneti ispravno bar jedan kliterijum.</span>
                   @endif
               </form>
            </div>
         </span>
                    ...
                    <table class="table table-hover mt-4 mb-4">
                        ...
                        @foreach($companies as $singleCompanyCertificate)
                            <tr wire:click="showModal({{ $singleCompanyCertificate->id }})" class="clickableTr">
                                ...
                                <td>{{$singleCompanyCertificate->getAttribute('valid_from_formatted')}}</td>
                                <td>{{$singleCompanyCertificate->getAttribute('valid_until_formatted')}}</td>
                                <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table class="table table-borderless">
                                            ...
                                            @if($selectedCertificate->note)
                                            <tr>
                                                <td>
                                                    <h5 class="dokomis-blue">Napomena</h5>
                                                    <span>{{$selectedCertificate->note}}</span>
                                                </td>
                                            </tr>
                                            @endif
                                            <tr>
